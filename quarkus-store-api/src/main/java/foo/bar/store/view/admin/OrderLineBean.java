        ...
        implements Serializable
{
    ...
    public List<OrderLine> getAll()
    {
        ...
        CriteriaQuery<OrderLine> criteria = this.entityManager.getCriteriaBuilder().createQuery( OrderLine.class );
        return this.entityManager.createQuery( criteria.select( criteria.from( OrderLine.class ) ) ).getResultList();
    }
