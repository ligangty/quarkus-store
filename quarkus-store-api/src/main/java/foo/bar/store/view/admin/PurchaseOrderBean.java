package foo.bar.store.view.admin;
...
import foo.bar.store.model.PurchaseOrder;
        ...
        implements Serializable
{
    ...
    public List<PurchaseOrder> getAll()
    {
        ...
        CriteriaQuery<PurchaseOrder> criteria =
                this.entityManager.getCriteriaBuilder().createQuery( PurchaseOrder.class );
        return this.entityManager.createQuery( criteria.select( criteria.from( PurchaseOrder.class ) ) )
                                 .getResultList();
    }
